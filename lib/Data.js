...
module.exports = class Data {
   ...
   * is an object. If the value doesnt exist, one is created as an empty object.
   *
   ...
   * @throws {Error} Thrown if the value is anything but an object.
   */
  ref(name, def) {
    ...
    if (typeof val !== 'object') {
      throw new Error(
          'The value "' + name +
          '" can not be used as a reference as its a "' +
          (typeof val) + '".'
      );
    }
